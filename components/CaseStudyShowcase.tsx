...
const chapters = [
  {
    ...
    body: "Invoices sent by hand, no one following up, and a growing customer base. They'd drifted to waiting 52 days to get paid. LunarLogic took over the whole getting-paid process, and within two billing cycles $65,000 in cash showed up — not from new work, but from money they were already owed.",
  ...
  },
  {
    ...
    body: "Complicated project billing, hit-or-miss follow-up, and invoices sitting unpaid for 90 days. LunarLogic connected to their accounting software, put every project on the same reminder schedule, and matched payments to invoices automatically. They went from waiting 61 days to get paid to 37 — a 24-day jump in the first two billing cycles.",
