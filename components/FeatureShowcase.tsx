...
const chapters = [
  {
    ...
    title: "Sales orders become invoices in seconds.",
    body: "A job is approved. AI reads the details, validates the customer against your accounting system, and sends a formatted invoice — all before you've looked up from your desk. Processing time drops from 19 minutes to under 3.",
  ...
  },
  {
    ...
    title: "Reminders run every weekday. Without you.",
    body: "A systematic multi-touch sequence fires automatically based on invoice age. Day 3, 7, 14, 21 — each reminder calibrated to your client relationships. Your best clients get a lighter touch. Your chronically late payers get escalation. You get paid.",
