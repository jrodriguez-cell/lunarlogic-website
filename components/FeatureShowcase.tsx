        ...
        {chapters.map((chapter, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className={`text-xs font-bold uppercase tracking-widest flex-shrink-0 w-6 ${isOpen ? "text-blue-400" : "text-slate-600"}`}>
                  {chapter.step}
                </span>
                <span className={`text-sm font-semibold flex-1 ${isOpen ? "text-white" : "text-slate-300"}`}>
                  {chapter.label}
                </span>
                <svg
              ...
              >
                <div className="overflow-hidden">
                  <div className="px-4 pb-5 space-y-4">
                    <h3 className="text-xl font-extrabold text-white leading-tight">{chapter.title}</h3>
                    <p className="text-sm text-slate-400 leading-relaxed">{chapter.body}</p>
                    {chapter.mockup}
