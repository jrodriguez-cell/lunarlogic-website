...
const chapters = [
  {
    ...
    body: "From the moment a job is done to the money landing in your account, every step runs on its own. Invoices go out in seconds, reminders go out every week, and payments get matched to the right invoice for you. No one chasing customers, no awkward calls, no typing anything up.",
  ...
  },
  {
    ...
    body: "The bills you owe get collected in one place, sent to the right person to okay, and paid on schedule. The money going out becomes just as predictable as the money coming in. Nothing paid too early, nothing paid late, and nothing paid without a thumbs-up.",
